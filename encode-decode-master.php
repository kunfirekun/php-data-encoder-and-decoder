...
$privateKey1 	= 'NOWEINF32523EFW63HGBERV34235'; // user defined key1
    ...
    $string1 		=$email_encode ; // user defined value2
...
$privateKey2 	= 'DANFOVBWEVCB432HNFC032FH2QADJ'; // user defined key2
    $secretKey2		= 'g124hbfo02fg'; // user defined secret key2
    $encryptMethod2     = "AES-256-CBC";
    $string2		=$confirm_code_encode ; // user defined value2
    ...
    $output2= base64_encode($result2);  // output2 is a encripted value of the confirm_code_encode
